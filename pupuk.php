<?php
	...
	include('lib/db_pupuk.php');

	$puk = new Pupuk();
	$data = $puk->readAllPupuk();
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="pupuk.php"><svg class="glyph stroked calendar blank"><use xlink:href="#stroked-calendar-blank"/></svg>Pupuk</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Data Pupuk</h1>
			</div>
		</div><!--/.row-->
		...
		<a href="tpupuk.php"><button class="btn btn-primary">Tambah Data</button></a>
